...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><strong>Add Customer</strong></h5>
        </div>
        ...
        <div class="card-body">
            ...
            <form id="form-submit" action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="mb-3">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="name" placeholder="Input Name Here" value="{{ old('name') }}" class="form-control {{ $errors->has('name')? 'border-danger' : '' }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="date" name="date_of_birth" placeholder="Input Size Here" value="{{ old('date_of_birth') }}" class="form-control {{ $errors->has('date_of_birth')? 'border-danger' : '' }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="email" name="email" placeholder="Input Email Here" value="{{ old('email') }}" class="form-control {{ $errors->has('email')? 'border-danger' : '' }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="phone" placeholder="Input Phone Here" value="{{ old('phone') }}" class="form-control {{ $errors->has('phone')? 'border-danger' : '' }}">
                        </div>
                    </div>
